...
def generate_deploy_script(
    ...
    The script embeds K8s manifests, locustfile, and Locust Job manifest inline
    ...
    Returns:
        The deploy.sh script content as a string.
    """
    ...
    locustfile_escaped = locustfile.replace("'", "'\\''")
...
cmd_test() {{
    ...
    # Inject locustfile as ConfigMap
    kubectl create configmap gmt-locustfile -n "$NAMESPACE" \\
        --from-literal=locustfile.py='{locustfile_escaped}' \\
